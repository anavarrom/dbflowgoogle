...
public class DbFlow10GoogleConnectorKafkaResourceIT {
    ...
    @Autowired
    private DbFlow10GoogleConnectorKafkaProducer producer;

    @Autowired
    private DbFlow10GoogleConnectorKafkaConsumer consumer;
    ...
    @BeforeEach
    public void setup() {
        DbFlow10GoogleConnectorKafkaResource kafkaResource = new DbFlow10GoogleConnectorKafkaResource(producer);
    ...
    public void producedMessageHasBeenConsumed() throws Exception {
        restMockMvc.perform(post("/api/db-flow-10-google-connector-kafka/publish?message=test"))
