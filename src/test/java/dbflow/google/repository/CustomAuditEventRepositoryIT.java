package dbflow.google.repository;
...
import dbflow.google.config.audit.AuditEventConverter;
import dbflow.google.domain.PersistentAuditEvent;
...
import static dbflow.google.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
